  ...
  return (
    <div className="h-full w-full flex flex-col items-center justify-center select-none p-8 animate-in fade-in duration-300">
      <div className="flex flex-col items-center gap-6">
        ...
        <span className="font-sans text-2xl md:text-3xl font-semibold tracking-normal text-[var(--text-primary)] select-none">
          Arunaki Agent
        </span>
      </div>

      <div className="mt-20 text-sm md:text-base font-medium text-[var(--text-muted)] font-sans tracking-wide select-none">
        Work with Agent
      </div>
    </div>
  );
