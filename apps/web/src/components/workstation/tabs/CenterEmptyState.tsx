  ...
  return (
    <div className="h-full w-full flex flex-col items-center justify-center select-none p-8 animate-in fade-in duration-300">
      <div className="flex flex-col items-center gap-6">
        ...
        <span className="font-inter text-2xl md:text-3xl font-medium tracking-normal text-[var(--text-primary)] select-none">
          Arunaki Agent
        </span>
      </div>

      <div className="mt-20 text-sm md:text-base font-normal text-[var(--text-muted)] font-inter tracking-wide select-none">
