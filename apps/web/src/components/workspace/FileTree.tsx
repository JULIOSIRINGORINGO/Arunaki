...
export default function FileTree({
  ...
  return (
    <div className="flex flex-col h-full bg-[#121212] overflow-hidden text-xs">
      {/* Workspace Sub-header Bar (Flat & Flush) */}
      <div className="flex items-center justify-between px-3 h-8 bg-[#161616] shrink-0 border-b border-[#383838] select-none">
        <div className="flex items-center gap-1.5 min-w-0">
          <FolderOpen className="w-3.5 h-3.5 text-[#A3A3A3] shrink-0" />
          <span className="text-[#FFFFFF] font-medium text-xs tracking-wide truncate" title={workspaceName}>
      ...
      {/* Flat Tree List Container (No nested card border, flush layout) */}
