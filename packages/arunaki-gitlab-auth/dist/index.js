    ...
    const authHook = {
        ...
        async loader(auth) {
            ...
            if (authData.type === 'api') {
                ...
                // 1. metadata.instanceUrl — written by opencode when the PAT auth flow
                //    collects the instance URL prompt (opencode's `api` auth schema only
                        ...
                        async callback() {
                            ...
                            try {
                                ...
                                return {
                                    ...
                                    // correct GitLab instance. opencode's OAuth schema includes
                ...
                async authorize(inputs) {
                    ...
                    try {
                        ...
                        return {
                            ...
                            key: token,
                            provider: normalizedUrl,
                            // Persist the instance URL in metadata (opencode's `api` auth
