...
export const TypeId: TypeId = "~@arunaki/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@arunaki/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@arunaki/effect-sqlite-node/NodeSqliteClient")
