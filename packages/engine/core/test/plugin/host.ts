import type { PluginContext } from "@arunaki/plugin/v2/effect"
...
import type { IntegrationEnvMethod, IntegrationKeyMethod, IntegrationOAuthMethod } from "@arunaki/sdk/v2/types"
