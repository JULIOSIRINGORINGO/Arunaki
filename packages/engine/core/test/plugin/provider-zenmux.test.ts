...
import { ProviderPlugins } from "@arunaki/core/plugin/provider"
import { ZenmuxPlugin } from "@arunaki/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://arunaki.ai/", "X-Title": "arunaki" })
