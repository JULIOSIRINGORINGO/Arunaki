...
import type { EffectDrizzleSqlite } from "@arunaki/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@arunaki/ProjectDirectories") {}
