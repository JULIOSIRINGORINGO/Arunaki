...
import { ListAnchor } from "@arunaki/schema/session"
...
import { SessionDurable } from "@arunaki/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@arunaki/v2/Session") {}
