...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@arunaki/llm"
...
export class Service extends Context.Service<Service, Interface>()("@arunaki/v2/ToolRegistry") {}
