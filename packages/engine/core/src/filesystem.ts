...
import { Entry, FileSystem, FindInput, Match } from "@arunaki/schema/filesystem"
export { Entry, Match, Submatch } from "@arunaki/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@arunaki/v2/FileSystem") {}
