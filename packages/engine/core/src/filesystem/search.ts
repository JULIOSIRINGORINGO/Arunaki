...
export class Service extends Context.Service<Service, Interface>()("@arunaki/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.Arunaki_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
