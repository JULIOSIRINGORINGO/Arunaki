...
import { FileSystemWatcher } from "@arunaki/schema/filesystem-watcher"
...
declare const Arunaki_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof Arunaki_LIBC === "undefined" ? undefined : Arunaki_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@arunaki/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.Arunaki_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.Arunaki_EXPERIMENTAL_FILEWATCHER)) {
