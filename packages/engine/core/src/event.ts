...
import type { Data, Definition, Payload } from "@arunaki/schema/event"
...
import { Durable } from "@arunaki/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@arunaki/schema/event").ID
export type { Data, Definition, Payload } from "@arunaki/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@arunaki/Event") {}
