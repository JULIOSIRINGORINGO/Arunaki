...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/Arunaki.git")).toEqual({ owner: "sst", repo: "arunaki" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/Arunaki")).toEqual({ owner: "sst", repo: "arunaki" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/Arunaki.git")).toEqual({ owner: "sst", repo: "arunaki" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/Arunaki")).toEqual({ owner: "sst", repo: "arunaki" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/Arunaki.git")).toEqual({ owner: "sst", repo: "arunaki" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/Arunaki")).toEqual({ owner: "sst", repo: "arunaki" })
})
