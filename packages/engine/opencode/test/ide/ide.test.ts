...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders Arunaki_CALLER", () => {
    process.env["Arunaki_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode Arunaki_CALLER", () => {
    process.env["Arunaki_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown Arunaki_CALLER", () => {
    process.env["Arunaki_CALLER"] = "unknown"
