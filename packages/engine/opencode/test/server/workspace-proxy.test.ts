...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips Arunaki-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-Arunaki-directory"]).toBeUndefined()
      expect(forwarded["x-Arunaki-workspace"]).toBeUndefined()
