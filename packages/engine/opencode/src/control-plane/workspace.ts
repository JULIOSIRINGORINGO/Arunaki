...
import { EventSequenceTable, EventTable } from "@arunaki/core/event/sql"
import { FSUtil } from "@arunaki/core/fs-util"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { ProjectV2 } from "@arunaki/core/project"
import { Slug } from "@arunaki/core/util/slug"
...
import { WorkspaceEvent } from "@arunaki/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@arunaki/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        Arunaki_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        Arunaki_WORKSPACE_ID: config.id,
        Arunaki_EXPERIMENTAL_WORKSPACES: "true",
