      ...
      .add(
        HttpApiEndpoint.get("list", SessionPaths.list, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of all Arunaki sessions, sorted by most recently updated.",
          }),
        ),
        ...
        HttpApiEndpoint.get("get", SessionPaths.get, {
          ...
          OpenApi.annotations({
            ...
            summary: "Get session",
            description: "Retrieve detailed information about a specific Arunaki session.",
          }),
        ),
        ...
        HttpApiEndpoint.post("create", SessionPaths.create, {
          ...
          OpenApi.annotations({
            ...
            description: "Create a new Arunaki session for interacting with AI assistants and managing conversations.",
          }),
        ),
        ...
        HttpApiEndpoint.post("prompt", SessionPaths.prompt, {
          ...
          error: [HttpApiError.BadRequest, ApiNotFoundError, UnknownError],
        }).annotateMerge(
          OpenApi.annotations({
