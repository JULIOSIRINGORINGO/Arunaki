...
import { buildPrompt } from "@arunaki/core/session/compaction"
import { SessionCompactionEvent } from "@arunaki/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@arunaki/SessionCompaction") {}
