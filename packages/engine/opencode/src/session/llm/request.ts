...
const USER_AGENT = `Arunaki/${InstallationVersion}`
...
export const prepare = Effect.fn("LLMRequestPrep.prepare")(function* (input: PrepareInput) {
  ...
  const ArunakiProjectID = input.model.providerID.startsWith("arunaki")
  ...
  return {
    ...
    headers: {
      ...(input.model.providerID.startsWith("arunaki")
        ? {
            ...(ArunakiProjectID ? { "x-Arunaki-project": ArunakiProjectID } : {}),
            "x-Arunaki-session": input.sessionID,
            "x-Arunaki-request": input.user.id,
            "x-Arunaki-client": input.flags.client,
