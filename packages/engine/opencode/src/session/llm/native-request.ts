import type { JsonSchema, LLMRequest, ProviderMetadata } from "@arunaki/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@arunaki/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @arunaki/llm request objects from Arunaki's session/AI SDK-shaped data.
  return LLM.request({
