...
import type { ProviderMetadata, Usage } from "@arunaki/llm"
...
import { locationServiceMapLayer } from "@arunaki/core/location-services"
...
import { NonNegativeInt, optional } from "@arunaki/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".Arunaki", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@arunaki/Session") {}
