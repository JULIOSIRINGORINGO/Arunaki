...
export class Service extends Context.Service<Service, Interface>()("@arunaki/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __Arunaki_PHOTON_WASM_PATH?: string }).__Arunaki_PHOTON_WASM_PATH =
