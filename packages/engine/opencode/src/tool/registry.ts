...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@arunaki/plugin"
...
export function webSearchEnabled(providerID: ProviderV2.ID, flags = { exa: false, parallel: false }) {
  return (
    ...
    providerID === ProviderV2.ID.make("Arunaki-go") ||
    flags.exa ||
    flags.parallel
  )
}
...
export class Service extends Context.Service<Service, Interface>()("@arunaki/ToolRegistry") {}
