...
import type { AssistantMessage as ArunakiAssistantMessage, Message } from "@arunaki/sdk/v2"
...
export type AssistantTokenCost = Pick<ArunakiAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<ArunakiAssistantMessage, "role"> &
  Partial<Pick<ArunakiAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@arunaki/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@arunaki/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@arunaki/ACPUsage") {}
