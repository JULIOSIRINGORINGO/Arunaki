...
import { gitlabAuthPlugin as GitlabAuthPlugin } from "Arunaki-gitlab-auth"
import { PoeAuthPlugin } from "Arunaki-poe-auth"
...
export class Service extends Context.Service<Service, Interface>()("@arunaki/Plugin") {}
