...
import type * as SDK from "@arunaki/sdk/v2"
...
import { SessionShareTable } from "@arunaki/core/share/sql"
import { ProviderV2 } from "@arunaki/core/provider"
import { ModelV2 } from "@arunaki/core/model"
import { EventV2 } from "@arunaki/core/event"

const disabled = process.env["Arunaki_DISABLE_SHARE"] === "true" || process.env["Arunaki_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@arunaki/ShareNext") {}
