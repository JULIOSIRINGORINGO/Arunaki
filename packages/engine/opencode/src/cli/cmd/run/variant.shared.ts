...
//
// The saved variant persists across sessions in ~/.local/state/Arunaki/model.json
...
class Service extends Context.Service<Service, VariantService>()("@arunaki/RunVariant") {}
