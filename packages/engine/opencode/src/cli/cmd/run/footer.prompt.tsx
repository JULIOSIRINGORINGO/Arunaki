...
import { normalizePromptContent } from "@Arunaki-ai/tui/editor"
...
import { Arunaki_BASE_MODE, useBindings } from "@Arunaki-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Arunaki" } satisfies SlashOption,
    ]
