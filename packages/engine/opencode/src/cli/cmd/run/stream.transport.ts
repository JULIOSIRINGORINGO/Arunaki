...
import type { Event, GlobalEvent, ArunakiClient } from "@arunaki/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@arunaki/RunStreamTransport") {}
