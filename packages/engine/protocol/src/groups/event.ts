...
import type { Definition } from "@arunaki/schema/event"
...
export const ArunakiEvent = event.schema
export type ArunakiEvent = typeof ArunakiEvent.Type
export type ArunakiEventEncoded = typeof ArunakiEvent.Encoded
