...
export interface IntegrationHooks extends Hooks<{ transform: IntegrationDraft }> {
  readonly connection: {
    readonly active: (integrationID: string) => Promise<import("@arunaki/sdk/v2/types").ConnectionInfo | undefined>
    readonly resolve: (
      connection: import("@arunaki/sdk/v2/types").ConnectionInfo,
