...
class Database extends Context.Service<Database, DatabaseShape>()("@arunaki/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@arunaki/example/UserStore") {
