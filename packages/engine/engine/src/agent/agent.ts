...
import { AbsolutePath, type DeepMutable } from "@arunaki/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@arunaki/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".Arunaki", "plans", "*.md")]: "allow",
