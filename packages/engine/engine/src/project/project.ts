...
import { ProjectDirectoryTable, ProjectTable } from "@arunaki/core/project/sql"
import { ProjectDirectories } from "@arunaki/core/project/directories"
...
import { which } from "@arunaki/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@arunaki/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.Arunaki_FAKE_VCS)
