...
import { SessionStatusEvent } from "@arunaki/schema/session-status-event"
...
export class Service extends Context.Service<Service, Interface>()("@arunaki/SessionStatus") {}
