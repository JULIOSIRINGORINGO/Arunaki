      ...
      environment: Effect.fn("SystemPrompt.environment")(function* (model: Provider.Model) {
        ...
        const envLines = isScratch
          ...
          : [
              ...
              `  * NEVER dump internal script debugging, file collision details, or verbose step-by-step programming narrations into the user chat. Keep communications clean, focused, and user-friendly.`,
              ...
              `- NATIVE BUILTIN DOCUMENT TOOLS (INSTANT ZERO PYTHON DEPENDENCY):`,
              `  * Arunaki has pre-installed, native tools for reading and processing office documents:`,
              `    - Word documents (.docx): ALWAYS use the 'word_read' tool to instantly parse text, paragraphs, and tables. NEVER write Python scripts, NEVER import 'docx', and NEVER run 'pip install python-docx'.`,
              `    - Excel spreadsheets (.xlsx, .xls, .csv): ALWAYS use the 'excel_read' tool to inspect sheets, cells, formulas, and values.`,
              `    - PowerPoint presentations (.pptx): ALWAYS use the 'ppt_read' tool to inspect slides and shapes.`,
              `    - Text/Markdown/JSON/Code: ALWAYS use the 'read' tool.`,
              `  * FORBIDDEN DEPENDENCY INSTALLS: You must NEVER run 'pip install', 'npm install', or any package manager. All tools needed for document inspection are already built-in and ready to use natively.`,
