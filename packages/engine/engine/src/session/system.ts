      ...
      environment: Effect.fn("SystemPrompt.environment")(function* (model: Provider.Model) {
        ...
        const envLines = isScratch
          ...
          : [
              ...
              `  * SHELL POLICY: Do NOT run shell or Python commands for reading or recapping office documents. Native tools execute instantly in-memory without spawning terminal processes.`,
