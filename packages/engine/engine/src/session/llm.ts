...
import { llmClient } from "@arunaki/core/effect/app-node-platform"
...
import type { LLMEvent } from "@arunaki/llm"
import { LLMClient } from "@arunaki/llm/route"
import type { LLMClientService } from "@arunaki/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@arunaki/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via Arunaki's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @arunaki/llm. It
