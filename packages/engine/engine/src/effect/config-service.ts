 ...
 *   "@arunaki/ServerAuthConfig",
 *   {
 *     password: Config.string("Arunaki_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("Arunaki_SERVER_USERNAME").pipe(Config.withDefault("arunaki")),
 *   },
 * ) {}
 *
